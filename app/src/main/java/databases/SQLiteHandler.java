...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    public static final String KEY_EC1 = "emergencyContact1";
    public static final String KEY_EC2 = "emergencyContact2";
    public static final String KEY_EC3 = "emergencyContact3";

    Context context;
    private SQLiteDatabase readableDb,writeableDb;
    private ContentValues values;

    public SQLiteHandler(Context reference) {
    ...
    public void insertWebAccountInfo(String name, String email, String password){
    ...
    public void insertEmergencyContacts(String ec1, String ec2, String ec3){
